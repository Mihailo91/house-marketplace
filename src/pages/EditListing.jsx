...
useEffect(() =>{
    ...
    useEffect(() => {
        ...
        const fetchListing = async () =>{
            ...
            if(docSnap.exists){
                ...
                navigate('/')
                toast.error('Listing does not existing')
            }
        }
    ...
    const onSubmit = async (e) => {
        ...
        if (discountedPrice >= regularPrice) {
            setLoading(false)
            toast.error('Discounted price should be greater thane regular price')
            return
        }
        ...
        if (geolocationEnabled) {
            // geo location nisam zavrsio zbog platne kartice
        } else {
    ...
    const onMutate = (e) => {
        ...
        //text/booleans/nubmers
        if (!e.target.files) {
            setFormData((prevState) => ({
                ...prevState,
                [e.target.id]: boolean ?? e.target.value //if not boolean then use actual valur
            }))
        }
    }
